...
export class ProjectsService {
   ...
   */
  async getProject(projectId: string, organizationId: string): Promise<ProjectResponseDto> {
  ...
  async updateProject(
    ...
    this.logger.log(`Project updated: ${projectId} — status: ${updated.status}`);
  ...
  private mapToResponse(project: {
    ...
    return {
      ...
      qualityScore: project.qualityScore ? Number(project.qualityScore) : null,
