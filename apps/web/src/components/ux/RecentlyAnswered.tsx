...
export const RecentActivitySummary: React.FC<RecentActivitySummaryProps> = ({ className = '' }) => {
  ...
  return (
    <div className={`recent-activity ${className}`}>
      <h4 style={{ margin: '0 0 12px', fontSize: 14, color: 'var(--color-surface-600)' }}>
        📊 Recent Activity
      </h4>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 13 }}>
          ...
          <span style={{ fontWeight: 600, color: 'var(--color-success-800)' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 13 }}>
          <span>Last hour:</span>
          <span style={{ fontWeight: 600, color: 'var(--color-surface-600)' }}>
      ...
      {veryRecent.length > 0 && (
        <div
          style={{ marginTop: 16, paddingTop: 12, borderTop: '1px solid var(--color-surface-200)' }}
        >
...
export const RecentAnswersTimeline: React.FC<RecentAnswersTimelineProps> = ({
  ...
  return (
    <div className={`recent-timeline ${className}`}>
      <h4 style={{ margin: '0 0 16px', fontSize: 14, color: 'var(--color-surface-600)' }}>
        🕐 Recent Answers
      </h4>
