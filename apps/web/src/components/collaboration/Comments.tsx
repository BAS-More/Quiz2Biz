...
const styles = {
  ...
  avatar:
    'w-8 h-8 rounded-full bg-brand-500 text-white flex items-center justify-center text-sm font-semibold',
  ...
  reaction:
    'flex items-center gap-1 px-2 py-0.5 bg-surface-100 rounded-xl text-xs cursor-pointer border-none transition-colors',
  reactionActive: 'bg-brand-100 border border-brand-500',
  reactionCount: 'text-surface-500',
  commentActions: 'flex gap-2 mt-2',
  actionButton:
    'text-xs text-surface-500 bg-transparent border-none cursor-pointer px-2 py-1 rounded transition-colors',
  ...
  textarea:
    'w-full min-h-[80px] p-3 rounded-lg border border-surface-300 bg-surface-50 text-sm font-[inherit] resize-y outline-none',
  ...
  submitButton:
    'px-4 py-2 bg-brand-600 text-white border-none rounded-md text-sm font-medium cursor-pointer transition-colors',
  submitButtonDisabled: 'bg-surface-300 cursor-not-allowed',
  mentionDropdown:
    'absolute bg-surface-50 border border-surface-200 rounded-lg shadow-float max-h-[200px] overflow-y-auto z-[1000]',
  ...
  notificationBadge:
    'absolute top-0 right-0 bg-danger-600 text-white text-[10px] font-semibold px-1.5 py-0.5 rounded-full min-w-[16px] text-center',
  notificationPanel:
    'absolute top-full right-0 w-80 max-h-[400px] bg-surface-50 border border-surface-200 rounded-lg shadow-float overflow-y-auto z-[1000]',
  notificationHeader: 'flex justify-between items-center px-4 py-3 border-b border-surface-200',
  notificationItem:
    'flex gap-3 px-4 py-3 border-b border-surface-100 cursor-pointer transition-colors',
