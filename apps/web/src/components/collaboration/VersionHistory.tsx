...
const styles = {
  ...
  modalContent:
    'bg-surface-50 rounded-2xl w-full max-w-[700px] max-h-[80vh] overflow-hidden flex flex-col',
  ...
  closeButton:
    'bg-transparent border-none p-2 cursor-pointer text-surface-500 rounded-lg flex items-center justify-center',
  ...
  versionPreview:
    'text-sm text-surface-500 leading-normal overflow-hidden text-ellipsis line-clamp-2',
  versionActions: 'flex gap-2 mt-3',
  actionButton:
    'px-3 py-1.5 text-xs font-medium rounded-md border-none cursor-pointer transition-colors',
  ...
  trigger:
    'inline-flex items-center gap-1.5 px-3 py-1.5 text-[13px] font-medium bg-surface-100 text-surface-600 border-none rounded-md cursor-pointer transition-colors',
};
      ...
      <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
        <div className={styles.modalHeader}>
          <div>
            ...
            {questionText && (
              <p className="mt-1 text-[13px] text-surface-500">{questionText.slice(0, 50)}...</p>
            )}
          </div>
                    ...
                    <div className={styles.versionHeader}>
                      <div className={styles.versionNumber}>
                        ...
                        {compareMode && isCompareSelected && (
                          <span className="px-1.5 py-0.5 text-[10px] bg-brand-500 text-white rounded-full">
