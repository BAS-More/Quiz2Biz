...
const styles = {
  ...
  searchInput:
    'w-full py-3 pr-12 pl-4 text-base border-2 border-surface-200 rounded-xl outline-none transition-all duration-200 bg-surface-50',
  ...
  clearButton:
    'absolute right-12 bg-none border-none p-1 cursor-pointer text-surface-400 rounded-full flex items-center justify-center',
  resultsContainer:
    'absolute top-full left-0 right-0 mt-2 bg-surface-50 rounded-xl shadow-float max-h-[500px] overflow-y-auto z-[1000]',
  ...
  keyPointTag:
    'inline-flex items-center px-2.5 py-1 text-xs bg-brand-100 text-brand-800 rounded-2xl font-medium',
  resultsList: 'list-none m-0 p-0',
  resultItem:
    'px-4 py-3.5 border-b border-surface-100 cursor-pointer transition-colors duration-150',
  ...
  suggestionTag:
    'inline-flex items-center px-3 py-1.5 text-[13px] bg-surface-50 border border-surface-200 rounded-[20px] cursor-pointer transition-all duration-150 text-surface-600',
  recentSearches: 'p-4',
  recentTitle: 'text-xs font-semibold text-surface-400 mb-3 flex items-center gap-1.5',
  recentList: 'flex flex-col gap-1',
  recentItem:
    'flex items-center gap-2.5 px-3 py-2.5 rounded-lg cursor-pointer text-surface-600 text-sm transition-colors duration-150',
