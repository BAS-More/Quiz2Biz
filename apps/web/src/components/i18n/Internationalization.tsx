...
const styles = {
  switcher: 'relative',
  switcherButton: 'flex items-center gap-2 px-3 py-2 bg-surface-100 border border-surface-300 rounded-lg text-sm cursor-pointer transition-all duration-200',
  flag: 'text-lg',
  dropdown: 'absolute top-[calc(100%+4px)] right-0 min-w-[200px] bg-surface-50 rounded-lg shadow-lg z-[1000] overflow-hidden',
  dropdownItem: 'flex items-center gap-3 px-4 py-3 text-sm cursor-pointer transition-colors duration-200 border-none bg-transparent w-full text-left',
