...
const styles = {
  ...
  fixItem:
    'flex items-center justify-between px-3 py-2 bg-success-50 rounded-md border border-success-200',
  fixDescription: 'text-[13px] text-success-800 flex-1',
  fixButton:
    'px-3 py-1 text-xs bg-success-500 text-white border-none rounded cursor-pointer font-medium',
  ...
  resolvedBadge:
    'inline-flex items-center gap-1 text-xs text-success-600 bg-success-100 px-2 py-1 rounded',
  ...
  toggle:
    'w-11 h-6 bg-surface-200 rounded-xl relative cursor-pointer transition-colors duration-200',
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-3">
        <h3 className="m-0 text-base font-semibold">Recent Errors ({errors.length})</h3>
        <button
          onClick={clearErrors}
