...
exports.scoreCommand = new commander_1.Command('score')
    ...
    var config, targetSessionId, spinner, scoreData, offlineData, client, scoreColor, tableData, error_1;
        ...
        switch (_j.label) {
            case 0:
                ...
                if (!targetSessionId) {
                    ...
                    console.log(chalk_1.default.gray('Use: quiz2biz config set defaultSession <sessionId>'));
                    process.exit(1);
                }
            ...
            case 4:
                ...
                console.log("\n".concat(chalk_1.default.bold('Overall Score:'), " ").concat(scoreColor("".concat((scoreData.overallScore * 100).toFixed(1), "%"))));
                console.log("".concat(chalk_1.default.bold('Status:'), " ").concat(getScoreStatus(scoreData.overallScore)));
                ...
                if (options.detailed && scoreData.dimensions) {
                    ...
                    tableData = __spreadArray([
                        [chalk_1.default.bold('Dimension'), chalk_1.default.bold('Score'), chalk_1.default.bold('Coverage'), chalk_1.default.bold('Gap')]
                    ], scoreData.dimensions.map(function (dim) { return [
                        dim.name,
                ...
                console.log("  Sections left: ".concat((_b = (_a = scoreData.progress) === null || _a === void 0 ? void 0 : _a.sectionsLeft) !== null && _b !== void 0 ? _b : 'N/A'));
                console.log("  Questions left: ".concat((_d = (_c = scoreData.progress) === null || _c === void 0 ? void 0 : _c.questionsLeft) !== null && _d !== void 0 ? _d : 'N/A'));
                console.log("  Current section: ".concat((_f = (_e = scoreData.progress) === null || _e === void 0 ? void 0 : _e.currentSectionProgress) !== null && _f !== void 0 ? _f : 0, "/").concat((_h = (_g = scoreData.progress) === null || _g === void 0 ? void 0 : _g.currentSectionTotal) !== null && _h !== void 0 ? _h : 0));
                return [3 /*break*/, 6];
            case 5:
                error_1 = _j.sent();
