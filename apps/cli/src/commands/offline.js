...
exports.offlineCommand
    ...
    return __generator(this, function (_a) {
        ...
        try {
            ...
            console.error(chalk_1.default.red("Failed to import: ".concat(error instanceof Error ? error.message : 'Unknown error')));
            process.exit(1);
        }
        return [2 /*return*/];
    });
...
exports.offlineCommand
    ...
    var outputPath = options.output || "quiz2biz-offline-".concat(sessionId.substring(0, 8), ".json");
