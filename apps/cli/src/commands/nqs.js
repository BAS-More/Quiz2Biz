      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              client.getNextQuestions(targetSessionId, {
          ...
          case 2:
            ...
            suggestions.questions.forEach(function (q, i) {
              ...
              console.log(
                '   '
                  .concat(chalk_1.default.gray('Dimension:'), ' ')
                  .concat(q.dimension, ' | ')
                  .concat(chalk_1.default.gray('Persona:'), ' ')
                  .concat(q.persona),
              );
              console.log(
                '   '
                  .concat(chalk_1.default.gray('Severity:'), ' ')
                  .concat(severityColor(''.concat((q.severity * 100).toFixed(0), '%')), ' | ')
                  .concat(chalk_1.default.gray('Priority:'), ' ')
                  .concat(priorityIcon),
              );
              if (q.bestPractice) {
                console.log(
                  '   '
                    .concat(chalk_1.default.gray('Best Practice:'), ' ')
                    .concat(chalk_1.default.italic(truncate(q.bestPractice, 80))),
                );
              }
            });
            // Summary
            ...
            console.log(
              chalk_1.default.gray(
                'Showing '
                  .concat(suggestions.questions.length, ' of ')
                  .concat(suggestions.totalRemaining, ' remaining questions'),
              ),
            );
            if (suggestions.topDimension) {
              console.log(
                chalk_1.default.gray(
                  'Focus area: '
                    .concat(suggestions.topDimension.name, ' (')
                    .concat(suggestions.topDimension.remaining, ' gaps)'),
                ),
              );
            }
            return [3 /*break*/, 4];
