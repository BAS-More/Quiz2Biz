-- CreateEnum
DO $$ BEGIN CREATE TYPE "UserRole" AS ENUM ('CLIENT', 'DEVELOPER', 'ADMIN', 'SUPER_ADMIN'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;

-- CreateEnum
DO $$ BEGIN CREATE TYPE "QuestionType" AS ENUM ('TEXT', 'TEXTAREA', 'NUMBER', 'EMAIL', 'URL', 'DATE', 'SINGLE_CHOICE', 'MULTIPLE_CHOICE', 'SCALE', 'FILE_UPLOAD', 'MATRIX'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;

-- CreateEnum
DO $$ BEGIN CREATE TYPE "SessionStatus" AS ENUM ('IN_PROGRESS', 'COMPLETED', 'ABANDONED', 'EXPIRED'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;

-- CreateEnum
DO $$ BEGIN CREATE TYPE "VisibilityAction" AS ENUM ('SHOW', 'HIDE', 'REQUIRE', 'UNREQUIRE'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;

-- CreateEnum
DO $$ BEGIN CREATE TYPE "DocumentCategory" AS ENUM ('CTO', 'CFO', 'BA'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;

-- CreateEnum
DO $$ BEGIN CREATE TYPE "DocumentStatus" AS ENUM ('PENDING', 'GENERATING', 'GENERATED', 'PENDING_REVIEW', 'APPROVED', 'REJECTED', 'FAILED'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;

-- CreateEnum
DO $$ BEGIN CREATE TYPE "StandardCategory" AS ENUM ('MODERN_ARCHITECTURE', 'AI_ASSISTED_DEV', 'CODING_STANDARDS', 'TESTING_QA', 'SECURITY_DEVSECOPS', 'WORKFLOW_OPS', 'DOCS_KNOWLEDGE'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
