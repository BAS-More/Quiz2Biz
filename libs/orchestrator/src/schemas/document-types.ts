...
const BUSINESS_PLAN: IDocumentTypeSchema = {
  ...
  name: 'Business Plan',
  description:
    'Comprehensive business plan covering market analysis, financials, operations, and growth strategy.',
  basePrice: 49.0,
  formats: ['DOCX', 'PDF'],
  sections: [
    {
      ...
      description:
        'High-level overview of the business, its value proposition, and key financials.',
      minWords: 500,
      maxWords: 1500,
      required: true,
      order: 1,
    },
    {
      ...
      description: 'Business structure, history, mission, vision, and legal entity details.',
      minWords: 300,
      maxWords: 800,
      required: true,
      order: 2,
    },
    {
      ...
      description:
        'Target market size (TAM/SAM/SOM), trends, customer segments, and competitive landscape.',
      minWords: 800,
      maxWords: 2000,
      required: true,
      order: 3,
    },
    {
      ...
      description: 'Detailed description of offerings, pricing model, and competitive advantages.',
      minWords: 400,
      maxWords: 1200,
      required: true,
      order: 4,
    },
    {
      ...
      description: 'Customer acquisition channels, sales funnel, partnerships, and growth tactics.',
      minWords: 500,
      maxWords: 1500,
      required: true,
      order: 5,
    },
    {
      ...
      description: 'Day-to-day operations, supply chain, technology stack, and key processes.',
      minWords: 400,
      maxWords: 1000,
      required: true,
      order: 6,
    },
    {
      ...
      description: 'Key personnel, roles, experience, and advisory board.',
      minWords: 200,
      maxWords: 600,
      required: true,
      order: 7,
    },
    {
      ...
      description:
        '3–5 year P&L, cash flow, balance sheet, break-even analysis, and key assumptions.',
      minWords: 600,
      maxWords: 2000,
      required: true,
      order: 8,
    },
    {
      ...
      description: 'Capital required, use of funds, and proposed terms.',
      minWords: 200,
      maxWords: 800,
      required: false,
      order: 9,
    },
    {
      key: 'appendices',
      title: 'Appendices',
      description: 'Supporting documents, charts, research data.',
      minWords: 0,
      maxWords: 2000,
      required: false,
      order: 10,
  ...
  standards: [
    {
      ...
      clause: '8.2',
      requirement: 'Business impact analysis and risk assessment must be documented.',
    },
    {
      standardId: 'SBA Guidelines',
      name: 'U.S. Small Business Administration',
      clause: 'Business Plan Template',
      requirement: 'Standard business plan structure with financial projections.',
    },
  ],
  minTotalWords: 4000,
  maxTotalWords: 15000,
...
const TECH_ARCHITECTURE: IDocumentTypeSchema = {
  ...
  description:
    'Technical architecture document covering system design, infrastructure, security, and deployment.',
  basePrice: 59.0,
  ...
  sections: [
    {
      ...
      description:
        'High-level architecture diagram description, component inventory, and technology choices.',
      minWords: 500,
      maxWords: 1500,
      required: true,
      order: 1,
    ...
    {
      key: 'component_design',
      title: 'Component Design',
      description:
        'Detailed design of each major component, APIs, data models, and integration points.',
      minWords: 800,
      maxWords: 3000,
      required: true,
      order: 2,
    },
    {
      ...
      description: 'Database schema, data flow diagrams, storage strategy, and backup procedures.',
      minWords: 500,
      maxWords: 1500,
      required: true,
      order: 3,
    },
    {
      ...
      description:
        'Authentication, authorization, encryption, vulnerability management, and compliance.',
      minWords: 500,
      maxWords: 1500,
      required: true,
      order: 4,
    },
    {
      ...
      description:
        'Cloud services, CI/CD pipeline, monitoring, scaling strategy, and disaster recovery.',
      minWords: 500,
      maxWords: 1500,
      required: true,
      order: 5,
    },
    {
      key: 'api_reference',
      title: 'API Reference',
      description: 'Endpoint specifications, request/response schemas, and authentication flows.',
      minWords: 400,
      maxWords: 2000,
      required: true,
      order: 6,
    },
    {
      ...
      description:
        'Load targets, bottleneck analysis, caching strategy, and horizontal scaling plan.',
      minWords: 300,
      maxWords: 1000,
      required: false,
      order: 7,
    },
    {
      ...
      description: 'Known debt items, prioritised remediation, and future architecture evolution.',
      minWords: 200,
      maxWords: 800,
      required: false,
      order: 8,
  ...
  standards: [
    {
      ...
      clause: 'A.14',
      requirement: 'System acquisition, development, and maintenance security controls.',
    },
    {
      standardId: 'ISO 25010',
      name: 'Systems and Software Quality',
      clause: '4.2',
      requirement:
        'Quality characteristics: reliability, security, performance efficiency, maintainability.',
    },
    {
      standardId: 'OWASP Top 10',
      name: 'Web Application Security Risks',
      clause: '2021',
      requirement: 'Address top 10 security vulnerabilities in architecture design.',
    },
  ],
  minTotalWords: 3500,
  maxTotalWords: 14000,
...
const MARKETING_STRATEGY: IDocumentTypeSchema = {
  ...
  description:
    'Go-to-market strategy with customer personas, channel strategy, campaigns, and metrics.',
  basePrice: 39.0,
  formats: ['DOCX', 'PDF'],
  sections: [
    {
      ...
      description: 'Industry landscape, trends, and competitive positioning.',
      minWords: 400,
      maxWords: 1200,
      required: true,
      order: 1,
    },
    {
      ...
      description: 'Detailed buyer personas with demographics, pain points, and buying behaviour.',
      minWords: 500,
      maxWords: 1500,
      required: true,
      order: 2,
    },
    {
      ...
      description: 'Unique selling points, positioning statement, and brand messaging.',
      minWords: 300,
      maxWords: 800,
      required: true,
      order: 3,
    },
    {
      ...
      description: 'Marketing channels, budget allocation, and expected ROI per channel.',
      minWords: 500,
      maxWords: 1500,
      required: true,
      order: 4,
    },
    {
      key: 'content_plan',
      title: 'Content Plan',
      description: 'Content calendar, topics, formats, and distribution strategy.',
      minWords: 300,
      maxWords: 1000,
      required: true,
      order: 5,
    },
    {
      ...
      description: 'Planned campaigns with timelines, budgets, and KPIs.',
      minWords: 400,
      maxWords: 1200,
      required: true,
      order: 6,
    },
    {
      ...
      description: 'KPIs, tracking setup, reporting cadence, and success criteria.',
      minWords: 200,
      maxWords: 600,
      required: true,
      order: 7,
  ...
  standards: [
    {
      standardId: 'ISO 20671',
      name: 'Brand Evaluation',
      clause: '5.3',
      requirement: 'Brand strength assessment methodology and metrics.',
    },
  ],
  minTotalWords: 2800,
  maxTotalWords: 10000,
...
const FINANCIAL_PROJECTIONS: IDocumentTypeSchema = {
  ...
  description:
    'Detailed financial model with P&L, cash flow, balance sheet, and sensitivity analysis.',
  basePrice: 59.0,
  formats: ['DOCX', 'PDF'],
  sections: [
    {
      ...
      description: 'Revenue drivers, cost structure, growth rates, and market assumptions.',
      minWords: 400,
      maxWords: 1200,
      required: true,
      order: 1,
    },
    {
      key: 'revenue_model',
      title: 'Revenue Model',
      description: 'Pricing tiers, unit economics, customer LTV, and revenue streams.',
      minWords: 500,
      maxWords: 1500,
      required: true,
      order: 2,
    },
    {
      ...
      description: '3–5 year projected P&L with monthly breakdown for Year 1.',
      minWords: 300,
      maxWords: 1000,
      required: true,
      order: 3,
    },
    {
      ...
      description: 'Operating, investing, and financing cash flows with runway analysis.',
      minWords: 300,
      maxWords: 1000,
      required: true,
      order: 4,
    },
    {
      key: 'balance_sheet',
      title: 'Balance Sheet',
      description: 'Projected assets, liabilities, and equity over the forecast period.',
      minWords: 200,
      maxWords: 800,
      required: true,
      order: 5,
    },
    {
      ...
      description: 'Break-even point calculation, contribution margin, and timeline.',
      minWords: 200,
      maxWords: 600,
      required: true,
      order: 6,
    },
    {
      ...
      description: 'Best/base/worst case scenarios with key variable impacts.',
      minWords: 300,
      maxWords: 800,
      required: true,
      order: 7,
    },
    {
      key: 'funding_use',
      title: 'Use of Funds',
      description: 'Detailed allocation of requested capital across categories.',
      minWords: 200,
      maxWords: 600,
      required: false,
      order: 8,
  ...
  standards: [
    {
      ...
      clause: 'IAS 1',
      requirement: 'Financial statement presentation and classification standards.',
    },
    {
      standardId: 'AASB',
      name: 'Australian Accounting Standards Board',
      clause: 'AASB 101',
      requirement: 'Presentation of financial statements for Australian entities.',
    },
  ],
  minTotalWords: 2500,
  maxTotalWords: 10000,
  ...
  sections: [
    {
      ...
      description: 'Market problem, pain points, and why existing solutions fail.',
      minWords: 200,
      maxWords: 500,
      required: true,
      order: 1,
    },
    {
      key: 'solution',
      title: 'Solution',
      description: 'Product description, unique approach, and key differentiators.',
      minWords: 200,
      maxWords: 600,
      required: true,
      order: 2,
    },
    {
      ...
      description: 'TAM/SAM/SOM, growth trajectory, and timing thesis.',
      minWords: 200,
      maxWords: 600,
      required: true,
      order: 3,
    },
    {
      ...
      description: 'Revenue model, pricing, unit economics, and scalability.',
      minWords: 200,
      maxWords: 500,
      required: true,
      order: 4,
    },
    {
      ...
      description: 'Key metrics, growth trajectory, partnerships, and social proof.',
      minWords: 200,
      maxWords: 500,
      required: true,
      order: 5,
    },
    {
      key: 'team',
      title: 'Team',
      description: 'Founders, key hires, advisors, and why this team wins.',
      minWords: 150,
      maxWords: 400,
      required: true,
      order: 6,
    },
    {
      ...
      description: 'High-level revenue, burn rate, and path to profitability.',
      minWords: 150,
      maxWords: 400,
      required: true,
      order: 7,
    },
    {
      key: 'ask',
      title: 'The Ask',
      description: 'Funding amount, valuation, use of funds, and timeline.',
      minWords: 150,
      maxWords: 400,
      required: true,
      order: 8,
  ...
  standards: [
    {
      ...
      name: 'Australian Accounting Standards Board',
      clause: 'AASB 101',
      requirement: 'Financial claims must align with accounting standards.',
    },
  ],
  minTotalWords: 1500,
  maxTotalWords: 5000,
  ...
  sections: [
    {
      ...
      description: 'Core system prompts for each AI agent role in the development workflow.',
      minWords: 500,
      maxWords: 2000,
      required: true,
      order: 1,
    },
    {
      ...
      description: 'Reusable prompt templates for common development tasks.',
      minWords: 400,
      maxWords: 1500,
      required: true,
      order: 2,
    ...
    {
      key: 'validation_prompts',
      title: 'Validation Prompts',
      description: 'Prompts for code review, testing, and quality assurance.',
      minWords: 300,
      maxWords: 1000,
      required: true,
      order: 4,
    },
    {
      ...
      description: 'Strategies for managing context windows and conversation history.',
      minWords: 200,
      maxWords: 800,
      required: false,
      order: 5,
  ...
  standards: [
    {
      ...
      name: 'Systems and Software Quality',
      clause: '4.2',
      requirement: 'Quality model for software development outputs.',
    },
  ],
  minTotalWords: 1800,
  maxTotalWords: 8000,
...
const PRIVACY_POLICY: IDocumentTypeSchema = {
  ...
  name: 'Privacy Policy',
  description:
    'GDPR/APPs-compliant privacy policy tailored to the business and its data practices.',
  basePrice: 34.0,
  formats: ['DOCX', 'PDF', 'MARKDOWN'],
  sections: [
    {
      ...
      description: 'Types of personal information collected, collection methods, and lawful basis.',
      minWords: 300,
      maxWords: 800,
      required: true,
      order: 1,
    },
    {
      key: 'data_use',
      title: 'Use of Data',
      description: 'Purposes for processing, legitimate interests, and consent mechanisms.',
      minWords: 300,
      maxWords: 800,
      required: true,
      order: 2,
    },
    {
      ...
      description: 'Third parties, processors, international transfers, and safeguards.',
      minWords: 300,
      maxWords: 800,
      required: true,
      order: 3,
    },
    {
      ...
      description: 'Retention periods, deletion policies, and archival procedures.',
      minWords: 200,
      maxWords: 600,
      required: true,
      order: 4,
    },
    {
      key: 'user_rights',
      title: 'User Rights',
      description: 'Access, rectification, erasure, portability, and objection rights.',
      minWords: 300,
      maxWords: 800,
      required: true,
      order: 5,
    },
    {
      ...
      description: 'Technical and organisational measures to protect personal data.',
      minWords: 200,
      maxWords: 600,
      required: true,
      order: 6,
    },
    {
      ...
      description: 'Cookie policy, tracking technologies, and opt-out mechanisms.',
      minWords: 200,
      maxWords: 500,
      required: true,
      order: 7,
    },
    {
      ...
      description: 'Data controller details, DPO contact, and complaint procedures.',
      minWords: 100,
      maxWords: 300,
      required: true,
      order: 8,
  ...
  standards: [
    {
      ...
      clause: 'Art. 13/14',
      requirement: 'Information to be provided to data subjects at collection.',
    },
    {
      standardId: 'APPs',
      ...
      clause: 'APP 1, 5',
      requirement:
        'Open and transparent management of personal information; notification of collection.',
    },
    {
      standardId: 'ISO 27701',
      name: 'Privacy Information Management',
      clause: '7.2',
      requirement: 'Conditions for collecting and processing personally identifiable information.',
    },
  ],
  minTotalWords: 2000,
  maxTotalWords: 7000,
  ...
  sections: [
    {
      key: 'overview',
      title: 'Overview',
      description: 'Document purpose, scope, and intended audience.',
      minWords: 200,
      maxWords: 800,
      required: true,
      order: 1,
    },
    {
      key: 'main_content',
      title: 'Main Content',
      description: 'Primary content sections as defined by the user.',
      minWords: 500,
      maxWords: 5000,
      required: true,
      order: 2,
    ...
    },
    {
      key: 'appendices',
      title: 'Appendices',
      description: 'Supporting materials, references, and additional data.',
      minWords: 0,
      maxWords: 2000,
      required: false,
      order: 4,
...
export const DOCUMENT_SCHEMAS: ReadonlyMap<DocumentSlug, IDocumentTypeSchema> = new Map<
  DocumentSlug,
  IDocumentTypeSchema
>([
